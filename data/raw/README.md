...
### OpenSecrets / FEC
- **URL:** https://www.opensecrets.org/bulk-data (free API key at https://www.opensecrets.org/api/admin/index.php)
- **Files:**
  - `data/raw/opensecrets/lobbying.csv` — columns: `Client, Ticker, Total Lobbying Spend (USD), Year`
  - `data/raw/opensecrets/contributions.csv` — columns: `Donor Organization, Ticker, Total PAC Contributions (USD), Cycle`
